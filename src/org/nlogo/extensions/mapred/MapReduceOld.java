...
public class MapReduceOld extends DefaultCommand
{
	Logger logger = Logger.getLogger(MapReduceOld.class);
	...
	public void perform(Argument args[], Context context) throws ExtensionException
	{
		...
		Network hnetwork= MapRedProto.network;
		MapRedProto.network= network; //Really nastyworkaround
